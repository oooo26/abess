...
def pywrap_DAG(x, n, p, normalize_type, max_iter, exchange_num, path_type, is_warm_start, ic_type, ic_coef, Kfold, gindex, sequence, cv_fold_id, s_min, s_max, screening_size, always_select, early_stop, thread, sparse_matrix, splicing_type, sub_search, A_init, beta_out, coef0_out, train_loss_out, ic_out):
