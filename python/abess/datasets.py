...
class make_dag_data:
    r"""
    Generate datasets for directed acyclic graph.
    ...
    k: int, optional, default=0
        If k>0, it indicates the number of nonzero coefficients
        in the underlying regression model.
    proba: float, optional, default=0.4
        If k=0, the directed edges will be created under this
        probability.
    snr: float, optional, default=1.0
